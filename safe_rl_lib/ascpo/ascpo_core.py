...
class MLPActorCritic(nn.Module):
    ...
    def __init__(self, observation_space, action_space, output_activation,
        ...
        self.vc  = MLPMaxCostCritic(obs_dim, hidden_sizes, activation, output_activation).to(self.device)
