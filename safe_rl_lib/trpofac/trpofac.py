...
def trpofac(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        ...
        backtrack_iters=100, model_save=False, lam_lr=1e-5, exp_name=None, resume=None):
    """
...
if __name__ == '__main__':
    ...
    trpofac(lambda : create_env(args), actor_critic=core.MLPActorCritic,
        ...
        model_save=model_save, target_kl=args.target_kl, lam_lr = args.lam_lr, exp_name=exp_name, resume=args.resume)