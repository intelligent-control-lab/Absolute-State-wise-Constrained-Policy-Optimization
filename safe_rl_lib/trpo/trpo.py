...
class TRPOBuffer:
    ...
    def store(self, obs, act, rew, val, logp, cost, mu, logstd):
        """
    ...
    def finish_path(self, last_val=0, ep_cost=0):
        """
...
def trpo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    for epoch in range(epochs):
        for t in range(local_steps_per_epoch):
            ...
            # save and log
            buf.store(o, a, r, v, logp, info['cost'], mu, logstd)
...
if __name__ == '__main__':
    ...
    trpo(lambda : create_env(args), actor_critic=core.MLPActorCritic,
        ...
        max_ep_len=args.max_ep_len, resume=args.resume, exp_name=exp_name)