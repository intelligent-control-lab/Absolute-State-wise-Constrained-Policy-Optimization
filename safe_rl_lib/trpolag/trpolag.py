...
def trpolag(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        ...
        target_cost = 1.5, logger_kwargs=dict(), save_freq=20, backtrack_coeff=0.8, 
        backtrack_iters=100, model_save=False, exp_name=None, lam_ratio=1.0, resume=None):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lam_ratio', type=float, default=0.5)
    ...
    trpolag(lambda : create_env(args), actor_critic=core.MLPActorCritic,
        ...
        exp_name=exp_name, lam_ratio=args.lam_ratio, resume=args.resume)