...
class MLPActorCritic(nn.Module):
    ...
    def __init__(self, observation_space, action_space, output_activation=nn.Softplus, 
        ...
        self.vc  = MLPMaxCritic(obs_dim, hidden_sizes, activation, output_activation).to(self.device)
